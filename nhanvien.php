...
<body>
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="nhanvien.php">Nhân viên</a>
            </li>
            <li class="nav-item">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $sql = "SELECT * from nhanviencongty ";
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr>';
                        echo '<th scope="row">' . $row['Ma_nv'] . '</th>';
                        echo '<td>' . $row['Ten_nv'] . '</td>';
                        echo '<td>' . $row['Diachi_nv'] . '</td>';
                        echo '<td>' . $row['Gioitinh_nv'] . '</td>';
                        echo '<td>' . $row['SDT_nv'] . '</td>';
                        echo '</tr>';
                    }
                }
